...
description: Automatically generate clear, comprehensive API documentation from your codebase.
when_to_use: Use when you need to document a new API, update existing API documentation, or create OpenAPI/Swagger specifications.
---
